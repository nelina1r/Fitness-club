...
@Service
public class CardFilterService implements FilterService {
    @Override
    public Specification<Card> generateSearchSpecifications(String search) {
        SpecificationsBuilder<Card> builder = new SpecificationsBuilder<>();
