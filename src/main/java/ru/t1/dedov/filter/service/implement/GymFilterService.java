...
@Service
public class GymFilterService implements FilterService {
    @Override
    public Specification<Gym> generateSearchSpecifications(String search) {
        SpecificationsBuilder<Gym> builder = new SpecificationsBuilder<>();
